  ...
  return (
    <div className='pt-20 min-h-screen'>
        ...
        <div className='mt-20 relative'>
          ...
          <AnimatePresence>
          <motion.div key={activeLink} className={`absolute left-[15%] top-1/2 -translate-y-1/2 bg-white/90  py-16 w-[440px] rounded-xl `} initial={{opacity : 0}} animate={{opacity : [0.0, 0.0, 0.2, 0.9] }} transition={{duration : 1.2}} >
            <p className='text-2xl items-start ml-16'>
              LeafLodge Hotels <br /> and suites - Detroit
            </p>
            <motion.div className='border-2 border-muted-foreground text-lg ml-auto px-8 py-3 w-fit mt-12 mr-16 cursor-pointer'
               whileHover={{
