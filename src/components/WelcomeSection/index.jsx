...
export default function WelcomeSection() {
  return (
    ...
    Prent bebegt med nödobiktiga såskade pregen. Sper nihonat. Löck paltkoma, lockdown. Stenoserat resam inte epibel, lynde teraligen. 
        ...
        <div className='grid grid-cols-2 grid-flow-row px-28 gap-0'>
            <ImageCell src='/welcomeOne.png' className='w-full'/>
            <TextCell className="bg-green-light">
            ...
            <TextCell className="bg-green-template text-white">
                <TextCellTitle>ENTICING FOOD & BEVERAGE</TextCellTitle>
                <TextCellDescription>masamma receptmotionär syska: vovis. Tesyde kas dilig. Hölibäl prenar abtologi fönde. 
                Prent bebegt med nödobiktiga såskade pregen. Sper nihonat. Löck paltkoma, lockdown. Stenoserat resam inte epibel, lynde teraligen. 
                </TextCellDescription>
            </TextCell>
            <ImageCell src='/welcometwo.png' className='w-full' />

            <ImageCell src='/welcomethree.png' className='w-full'/>
            <TextCell className="bg-gray-template">
